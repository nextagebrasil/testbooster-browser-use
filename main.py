...
async def main():
    ...
    agent = Agent(
        ...
        use_vision=True, #Quando ativado, o modelo processa informações visuais de páginas da web; Para GPT-4o, o processamento de imagem custa aproximadamente 800-1000 tokens (~US$ 0,002) por imagem (mas isso depende do tamanho de tela definido)
